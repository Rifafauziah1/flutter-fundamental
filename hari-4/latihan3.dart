...
void main(){
    ...
    case "jumat":  
             { print('Hidup tak selamanya tentang pacar.'); break; }
    case "sabtu":  
             { print('Rumah bukan hanya sebuah tempat, tetapi itu adalah perasaan.'); break; }
    case "minggu": 
             { print('Hanya seseorang yang takut yang bisa bertindak berani. Tanpa rasa takut itu tidak ada apapun yang bisa disebut berani.'); break; }
    default:  { print('Error'); }}
}